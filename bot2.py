...
if __name__ == '__main__':
    ...
    an_array[2].method("and shout", 0)
    an_array[2].method("HELLLLLLLLOOOOOOOOOOOOOOO", 0)

    an_array[2].method("Hello, I'm Johan", 1)
    an_array[2].method("I just love to talk", 1)
    an_array[2].method("and shout", 1)
    an_array[2].method("HELLLLLLLLOOOOOOOOOOOOOOO", 1)
