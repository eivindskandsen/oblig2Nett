...
if __name__ == '__main__':
    ...
    an_array[2].method("You can mash em, u can stew em", 0)
    an_array[2].method("MOAHAHAA, put it in a stew", 0)

    an_array[2].method("Hello, I'm Annike", 1)
    an_array[2].method("I like walks", 1)
    an_array[2].method("Vettakolltoppen, have you been there", 1)
    an_array[2].method("It got a nice view", 1)
